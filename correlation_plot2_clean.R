...
CorrelatePlot2 <- function(samp1, samp2, assay_xr, assay, covnum){
  ...
  p2 <- p1 + geom_segment(aes(x = 0, y = 0.02, xend = 0.98, yend = 0.02)) +
    geom_segment(aes(x = 0.02, y = 0, xend = 0.02, yend = 0.98)) +
    geom_segment(aes(x = 0.98, y = 0, xend = 0.98, yend = 0.98)) +
    geom_segment(aes(x = 0, y = 0.98, xend = 0.98, yend = 0.98))
